...
CREATE TABLE fl_stag (
    ...
    distance real,
    prov2 character varying(50)
);


ALTER TABLE fl_stag OWNER TO yugabyte;

--
-- Name: fl_stag_seq_id_seq; Type: SEQUENCE; Schema: public; Owner: yugabyte
--

CREATE SEQUENCE fl_stag_seq_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE ONLY fl_stag ALTER COLUMN seq_id SET DEFAULT nextval('fl_stag_seq_id_seq'::regclass);
...
COPY fl_stag (seq_id, hiding_date_vc, hiding_date, hiding_blz, hiding_rider, finder_date_vc, finder_date, finder_blz, finder_rider, lat_degr, lon_degr, loc_desc, city, prov, distance, prov2) FROM stdin;
...
SELECT pg_catalog.setval('fl_stag_seq_id_seq', 4500, true);
