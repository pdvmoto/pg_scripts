...
COPY public.fl_stag (seq_id, hiding_date_vc, hiding_date, hiding_blz, hiding_rider, finder_date_vc, finder_date, finder_blz, finder_rider, lat_degr, lon_degr, loc_desc, city, prov, distance, prov2) FROM stdin;
